              ...
              <ul class="sidebar-menu">
                  ...
                  <li class="sub-menu <?php echo $menu == "Akademik" ? "active" : "" ?>">
                      ...
                      <ul class="sub">
                        ...
                        <li class="<?php echo $menu == "Akademik" && $submenu == "Ac_TahunAjaran" ? "active" : "" ?>"><a href="<?php echo base_url(''); ?>./data_akademik/tahun_ajaran">Tahun Ajaran</a></li>
                      </ul>
                  </li>
                  <?php if($level_user <3){?>
                    <li class="sub-menu <?php echo $menu == "Referensi" ? "active" : "" ?>">
                        ...
                        <ul class="sub">
                            <li class="<?php echo $menu == "Referensi" && $submenu == "R_Hari" ? "active" : "" ?>"><a href="<?php echo base_url(''); ?>./referensi/referensi_jenis_hari">Referensi - Hari</a></li>
                            ...
                            <li class="<?php echo $menu == "Referensi" && $submenu == "R_KKM" ? "active" : "" ?>"><a href="<?php echo base_url(''); ?>./referensi/referensi_kkm">Referensi - KKM</a></li>
                            ...
                            <li class="<?php echo $menu == "Referensi" && $submenu == "R_Ujian" ? "active" : "" ?>"><a href="<?php echo base_url(''); ?>./referensi/referensi_jenis_ujian">Referensi - Ujian</a></li>
