    ...
    <section class="panel">
      ...
      <div class="panel-body">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input name="nis" type="text" required="required" class="form-control" id="nis" maxlength="60">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input name="nisn" type="text" required="required" class="form-control" id="nisn" maxlength="60">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input name="tempat_lahir" type="text" required="required" class="form-control" id="tempat_lahir" maxlength="60">
         ...
         <div class="form-group">
          ...
          <div class="col-sm-10">
            <input name="tgl_lahir" type="date" required="required" class="form-control" id="tgl_lahir" maxlength="60">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input name="daerah" type="text" required="required" class="form-control" id="daerah" maxlength="60">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input name="daerah_ar" type="text" required="required" class="form-control" id="daerah_ar" maxlength="60">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input name="tgl_akhir" type="date" class="form-control" id="tgl_akhir" maxlength="60">
