<div class="row">
  <div class="col-lg-12">
    <section class="panel">
      <header class="panel-heading">Insert Ruangan</header>
      <div class="panel-body">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input name="alias" type="text" required="required" class="form-control" id="alias" maxlength="60">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input name="ur_alias" type="text" required="required" class="form-control" id="ur_alias" maxlength="60">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input name="kapasitas" type="number" required="required" class="form-control" id="kapasitas" maxlength="60">
