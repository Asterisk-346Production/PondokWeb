    ...
    <section class="panel">
      ...
      <div class="panel-body">
          ...
          <label class="col-sm-2 control-label">Jenis Wali</label>
            <div class="col-sm-10">
              <select name="id_jns_wali" required id="id_jns_wali" class="form-control m-bot15">
                <?php foreach ($M_jenis_santri_wali as $datax) {
                   echo '<option value="'.$datax['id_jns_wali'].'">'.$datax['uraian'].'</option>';
                } ?>
              </select>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input name="nama" type="text" required="required" class="form-control" id="nama" maxlength="60" value="<?php echo $data['nama']; ?>">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input name="nama_ar" type="text" required="required" class="form-control" id="nama_ar" maxlength="60" value="<?php echo $data['nama_ar']; ?>">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input name="alamat" type="text" required="required" class="form-control" id="alamat" maxlength="60" value="<?php echo $data['alamat']; ?>">
         ...
         <div class="form-group">
          ...
          <div class="col-sm-10">
            <input name="no_telp" type="date" required="required" class="form-control" id="no_telp" maxlength="60" value="<?php echo $data['no_telp']; ?>">
