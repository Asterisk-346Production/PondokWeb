<div class="row">
  <div class="col-lg-12">
    <section class="panel">
      <header class="panel-heading">Update Tahun Ajaran</header>
      <div class="panel-body">
        <?php echo form_open(base_url('data_akademik/tahun_ajaran/doUpdateTdTahunAjaran'), 'class="form-horizontal "'); ?>
