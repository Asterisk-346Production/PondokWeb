      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu">                
                  ...
                  <?php }?>
                  <?php if($level_user ==2 || $level_user ==1) {?>
                  <li class="sub-menu">
                      <a href="javascript:;" class="">
                          <i class="icon_id-2"></i>
                      ...
                      <ul class="sub">
                          <li><a class="" href="<?php echo base_url(''); ?>./dataSiswa">Data Santri</a></li>
                          <li><a class="" href="<?php echo base_url(''); ?>./dataPengajar"></a>Data Pengajar</li>
                          <li><a class="" href="<?php echo base_url(''); ?>./dataNilaiSiswa">Data Nilai Santri</a></li>
                          <li><a class="" href="<?php echo base_url(''); ?>./dataKelas">Data Kelas</a></li>
                          <li><a class="" href="<?php echo base_url(''); ?>./dataSaldo">Data Tabungan Santri</a></li>
                          <li><a class="" href="<?php echo base_url(''); ?>./dataSPP">Data SPP</a></li>
                          <li><a class="" href="<?php echo base_url(''); ?>./dataAsrama">Data Pondok/ Asrama</a></li>
                          <li><a class="" href="<?php echo base_url(''); ?>./dataKelas">Data Kelas</a></li>
                          <li><a class="" href="<?php echo base_url(''); ?>./dataPelajaran">Data Pelajaran</a></li>
                          <li><a class="" href="<?php echo base_url(''); ?>./agendaKegiatan">Agenda Kegiatan</a></li>
                      </ul>
                  </li>
                  <?php }?>
                  <li>
           ...
           <div class="panel-body">
                            <div class="col-lg-2 col-sm-2">
                              ...
                              <div class="follow-ava">
                                  <img src="<?php echo base_url(); ?>assets/adminLte/img/avatar1_small.jpg" alt="">
                              </div>
                              <h6>Administrator</h6>
                            </div>
                            ...
                            <div class="col-lg-6 col-sm-6 follow-info weather-category">
                                      <ul>
                                          <li class="active">
                                              <h4>50</h4>
                                              <i class="icon_close_alt2"></i> Jumlah Saldo
                                          </li>
                                          <?php if($level_user == 3) {?>
                                          <li>
                                              <h4>1</h4>
                                              <i class="icon_check_alt2"></i> Ranking
                                          </li>
                                          <li>
                                              <h4>1-A</h4>
                                              <i class="icon_plus_alt2"></i> Kelas
                                          </li>
                                          <?php }?>
                                      </ul>
                            </div>
