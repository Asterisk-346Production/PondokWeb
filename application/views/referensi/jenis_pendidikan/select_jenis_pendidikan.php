                  ...
                  <div class="col-lg-12">
                     <section class="panel">
                              <header class="panel-heading">
                                <a class="btn btn-primary" href="<?php echo base_url().'referensi/referensi_jenis_pendidikan/addReferensiJenisPendidikan/'; ?>"><i class="icon_plus_alt2"></i> Tambah Data</a>
                              </header>
                              ...
                              <thead>
                                <tr>
                                  ...
                                  <th><i class="icon_cogs"></i> Action</th>
                                      ...
                                      <tbody>
                                        <?php $no=0; foreach ($m_jenis_pendidikan as $data): ?>
                                  <tr>
                                    <td><?php echo ++$no; ?></td>
                                    <td><?php echo $data['id_jns_pendidikan']; ?></td>
                                    <td><?php echo $data['uraian']; ?></td>
                                    <td><?php echo $data['fl_formal']; ?></td>
                                    <td><div class="btn-group">
                                      <a class="btn btn-success" href="<?php echo base_url().'referensi/referensi_jenis_pendidikan/update_jenis_pendidikan/'.$data['id_jns_pendidikan']; ?>"><i class="icon_pencil-edit"></i></a>
                                      <a class="btn btn-danger" href="<?php echo base_url().'referensi/referensi_jenis_pendidikan/delete_jenis_pendidikan/'.$data['id_jns_pendidikan']; ?>"><i class="icon_close_alt2"></i></a>
                                    </div></td>
                                  </tr>
                                <?php endforeach; ?>
                              </tbody>
