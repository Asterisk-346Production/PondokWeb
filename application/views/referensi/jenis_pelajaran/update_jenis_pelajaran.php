    ...
    <section class="panel">
      ...
      <div class="panel-body">
        <?php foreach ($m_jenis_komptensi as $data): ?>
          <?php echo form_open(base_url('referensi/referensi_jenis_pelajaran/doUpdateReferensiJenisPelajaran'), 'class="form-horizontal "'); ?>
          <input name="id" type="hidden" id="id" value="<?php echo $slug; ?>">
          <div class="form-group">
            <label class="col-sm-2 control-label">Nama Jenis pelajaran</label>
            <div class="col-sm-10">
