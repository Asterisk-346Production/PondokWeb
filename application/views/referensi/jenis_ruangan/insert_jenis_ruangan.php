                  ...
                  <div class="col-lg-12">
                     <section class="panel">
                              ...
                              <div class="panel-body">
                                  <?php echo form_open(base_url('referensi/referensi_jenis_ruangan/doInsertReferensiJenisRuangan'), 'class="form-horizontal "'); ?>
                                  <div class="form-group">
                                   ...
                                   <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                       ...
                                       <div class="form-group">
                                      <label class="col-sm-2 control-label">Uraian Jenis Karyawan English</label>
                                      <div class="col-sm-10">
