                  ...
                  <div class="col-lg-12">
                     <section class="panel">
                              <header class="panel-heading">
                                <a class="btn btn-primary" href="<?php echo base_url().'referensi/referensi_jenis_ruangan/addReferensiJenisRuangan/'; ?>"><i class="icon_plus_alt2"></i> Tambah Data</a>
                              </header>
                              ...
                              <thead>
                                <tr>
                                  ...
                                  <th><i class="icon_cogs"></i> Action</th>
                                      ...
                                      <tbody>
                                        <?php $no=0; foreach ($m_jenis_ruangan as $data): ?>
                                  <tr>
                                    <td><?php echo ++$no; ?></td>
                                    <td><?php echo $data['id_jns_ruangan']; ?></td>
