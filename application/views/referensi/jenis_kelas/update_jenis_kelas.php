<div class="row">
  <div class="col-lg-12">
    <section class="panel">
      <header class="panel-heading">Update Jenis Kelas</header>
      <div class="panel-body">
        <?php foreach($m_jenis_kelas as $data) : ?>
          <?php echo form_open(base_url('referensi/referensi_jenis_kelas/doUpdateReferensiJenisKelas'), 'class="form-horizontal "'); ?>
