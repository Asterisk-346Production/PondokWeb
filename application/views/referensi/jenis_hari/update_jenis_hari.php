<div class="row">
  <div class="col-lg-12">
    <section class="panel">
      <header class="panel-heading">Update Jenis Hari</header>
      <div class="panel-body">
        <?php foreach($m_jenis_hari as $data) : ?>
          <?php echo form_open(base_url('referensi/referensi_jenis_hari/doUpdateReferensiJenisHari'), 'class="form-horizontal "'); ?>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input name="uraian_en" type="text" required="required" class="form-control" id="uraian_en" maxlength="60" value ="<?php echo $data['uraian_en'] ?>">
