      ...
      <section id="main-content">
          <section class="wrapper">
			...
			<div class="row">
                  <div class="col-lg-12">
                     <section class="panel">
                              <header class="panel-heading">Update Jenis Karyawan</header>
                              <div class="panel-body">
                              <?php foreach($m_jenis_karyawan as $data) : ?>
                                  <?php echo form_open(base_url('referensi/referensi_jenis_karyawan/doUpdateReferensiJenisKaryawan'), 'class="form-horizontal "'); ?>
                                   <input name="id" type="hidden" id="id" value="<?php echo $slug; ?>">
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">Uraian Jenis Karyawan</label>
                                      <div class="col-sm-10">
                                   ...
                                   <div class="form-group">
                                      <label class="col-sm-2 control-label">Uraian Jenis Karyawan Arab</label>
                                      <div class="col-sm-10">
