...
(2, 1, 2, 2, '2017-01-16', 2, 1),
(3, 2, 1, 1, '2017-01-16', 1, 2),
(4, 2, 2, 2, '2017-01-16', 2, 2),
(5, 1, 2, 1, '2017-01-16', 2, 1);
...
CREATE TABLE `td_kelas_nilai` (
  ...
  `id_santri_nilai` int(6) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `td_kelas_nilai` (`id_kelas_nilai`, `id_kelas_jadwal`, `id_bayanat`, `nis`, `nilai_ujian`, `nilai_remed1`, `nilai_remed2`, `nilai_akhir`, `id_santri_nilai`) VALUES
(1, 1, 1, '151607001', 54.34, 56.44, 76.45, 75.00, NULL),
(2, 1, 4, '000111', 90.00, NULL, NULL, 90.00, NULL),
(3, 1, 5, '000111', 100.00, NULL, NULL, 100.00, NULL),
(4, 1, NULL, '000111', 75.00, NULL, NULL, 75.00, 1),
(5, 1, NULL, '000111', 75.00, NULL, NULL, 75.00, 2),
(6, 1, NULL, '000111', 100.00, NULL, NULL, 100.00, 3),
(7, 1, NULL, '000111', 100.00, NULL, NULL, 100.00, 4),
(8, 1, NULL, '000111', 100.00, NULL, NULL, 100.00, 5),
(9, 1, NULL, '151607001', 68.00, NULL, NULL, 68.00, 6),
(10, 1, NULL, '151607001', 71.00, NULL, NULL, 71.00, 7),
(11, 1, NULL, '151607001', 76.00, NULL, NULL, 76.00, 8),
(12, 2, 5, '000111', 75.00, NULL, NULL, 75.00, 6);
...
--
-- Dumping data for table `td_santri_nilai`
--

INSERT INTO `td_santri_nilai` (`id_santri_nilai`, `nis`, `id_jns_pelajaran`, `id_jns_jadwal`, `nilai_akhir`) VALUES
(3, '000111', 1, 1, 100.00),
(4, '000111', 2, 1, 100.00),
(5, '000111', 3, 1, 100.00),
(6, '151607001', 1, 1, 68.00),
(7, '151607001', 2, 1, 71.00),
(8, '151607001', 3, 1, 76.00);
...
(27, 1, 'insert data', 'data_akademik : santri_nilai', 'berhasil', '2017-01-14 13:21:20', 'rio'),
(28, 1, 'insert data', 'data_akademik : santri_nilai', 'berhasil', '2017-01-14 13:21:20', 'rio'),
(29, 1, 'insert data', 'data_akademik : santri_nilai', 'berhasil', '2017-01-15 05:58:38', 'rio'),
(30, 1, 'insert data', 'data_akademik : santri_nilai', 'berhasil', '2017-01-15 05:58:38', 'rio'),
(31, 1, 'insert data', 'data_akademik : santri_nilai', 'berhasil', '2017-01-15 05:58:38', 'rio'),
(32, 1, 'insert data', 'data_akademik : santri_nilai', 'berhasil', '2017-01-15 07:18:41', 'rio'),
(33, 1, 'insert data', 'data_akademik : santri_nilai', 'berhasil', '2017-01-15 07:18:41', 'rio'),
(34, 1, 'insert data', 'data_akademik : santri_nilai', 'berhasil', '2017-01-15 07:18:41', 'rio');
...
--
ALTER TABLE `td_kelas_jadwal`
  MODIFY `id_kelas_jadwal` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `td_kelas_nilai`
  MODIFY `id_kelas_nilai` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
...
--
ALTER TABLE `td_santri_nilai`
  MODIFY `id_santri_nilai` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
