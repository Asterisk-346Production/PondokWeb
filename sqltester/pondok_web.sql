...
--
-- Dumping data untuk tabel `mtest`
--
...
(2, 2, '2017-01-03', '000111', 11, 78.00);

-- --------------------------------------------------------

--
-- Struktur dari tabel `td_karyawan`
--
...
--
-- Dumping data untuk tabel `td_karyawan`
--
...
--
-- Struktur dari tabel `td_karyawan_kompentensi`
--
...
--
-- Struktur dari tabel `td_karyawan_pendidikan`
--
...
CREATE TABLE `td_kelas` (
  ...
  `tgl_awal` date NOT NULL,
  `tgl_akhir` date NOT NULL,
  `id_jenis_kelas` varchar(20) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data untuk tabel `td_kelas`
--

INSERT INTO `td_kelas` (`id_kelas`, `id_ta`, `jumlah`, `tgl_awal`, `tgl_akhir`, `id_jenis_kelas`) VALUES
(1, 20170630, 30, '0000-00-00', '0000-00-00', '');

-- --------------------------------------------------------

--
-- Struktur dari tabel `td_kelas_dtl`
--
...
--
-- Struktur dari tabel `td_kelas_jadwal`
--
...
CREATE TABLE `td_kelas_jadwal` (
  ...
  `id_ruangan_jadwal` int(4) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data untuk tabel `td_kelas_jadwal`
--

INSERT INTO `td_kelas_jadwal` (`id_kelas_jadwal`, `semester`, `id_jns_pelajaran`, `id_kelas`, `tgl_ujian`, `id_jns_jadwal`, `id_ruangan_jadwal`) VALUES
(1, 0, 1, 1, '0000-00-00', 1, 1);

-- --------------------------------------------------------

--
-- Struktur dari tabel `td_kelas_jadwal_dtl`
--

CREATE TABLE `td_kelas_jadwal_dtl` (
  `id_jns_jadwal_dtl` int(6) NOT NULL,
  `id_kelas_jadwal` int(6) NOT NULL,
...
--
-- Struktur dari tabel `td_kelas_nilai`
--
...
--
-- Dumping data untuk tabel `td_kelas_nilai`
--
...
--
-- Struktur dari tabel `td_kelas_wali`
--
...
--
-- Struktur dari tabel `td_pembayaran`
--
...
--
-- Struktur dari tabel `td_pembayaran_dtl`
--
...
--
-- Struktur dari tabel `td_ruangan`
--
...
--
-- Dumping data untuk tabel `td_ruangan`
--
...
--
-- Struktur dari tabel `td_ruangan_jadwal`
--
...
('151607001', '123456', 0, 'nama', 'عبد الفتح', 'kota', '2016-12-26', '0000-00-00', '', '', '0000-00-00');
...
--
-- Struktur dari tabel `td_santri_wali`
--
...
--
-- Struktur dari tabel `td_tahun_ajaran`
--
...
--
-- Dumping data untuk tabel `td_tahun_ajaran`
--
...
--
-- Struktur dari tabel `tp_kelas_jadwal`
--
...
--
-- Dumping data untuk tabel `tp_log`
--
...
--
-- Struktur dari tabel `tp_santri_current`
--
...
--
-- Dumping data untuk tabel `tr_hari`
--
...
--
-- Struktur dari tabel `tr_jenis_beasiswa`
--
...
--
-- Struktur dari tabel `tr_jenis_jadwal`
--
...
--
-- Dumping data untuk tabel `tr_jenis_jadwal`
--
...
--
-- Struktur dari tabel `tr_jenis_jam`
--
...
--
-- Dumping data untuk tabel `tr_jenis_jam`
--
...
--
-- Struktur dari tabel `tr_jenis_karyawan`
--
...
--
-- Dumping data untuk tabel `tr_jenis_karyawan`
--

INSERT INTO `tr_jenis_karyawan` (`id_jns_karyawan`, `uraian`, `uraian_ar`, `keterangan`) VALUES
(0, 'fafa', 'jgkgj', 'jkgkgj'),
(1, 'Guru Ustad', 'غبي', 'Mengaji'),
(2, 'Guru Umum', '', '');

-- --------------------------------------------------------

--
-- Struktur dari tabel `tr_jenis_kelas`
--
...
--
-- Dumping data untuk tabel `tr_jenis_kelas`
--
...
--
-- Struktur dari tabel `tr_jenis_kompetensi`
--
...
--
-- Dumping data untuk tabel `tr_jenis_kompetensi`
--
...
--
-- Struktur dari tabel `tr_jenis_pelajaran`
--
...
--
-- Dumping data untuk tabel `tr_jenis_pelajaran`
--
...
--
-- Struktur dari tabel `tr_jenis_pembayaran`
--
...
--
-- Dumping data untuk tabel `tr_jenis_pembayaran`
--
...
--
-- Struktur dari tabel `tr_jenis_pendidikan`
--
...
--
-- Dumping data untuk tabel `tr_jenis_pendidikan`
--
...
--
-- Struktur dari tabel `tr_jenis_ruangan`
--
...
--
-- Dumping data untuk tabel `tr_jenis_ruangan`
--
...
--
-- Struktur dari tabel `tr_jenis_santri`
--
...
--
-- Dumping data untuk tabel `tr_jenis_santri`
--
...
--
-- Struktur dari tabel `tr_jenis_skill`
--
...
--
-- Dumping data untuk tabel `tr_jenis_skill`
--
...
--
-- Struktur dari tabel `tr_jenis_status`
--
...
--
-- Dumping data untuk tabel `tr_jenis_status`
--
...
--
-- Struktur dari tabel `tr_jenis_transaksi`
--
...
--
-- Dumping data untuk tabel `tr_jenis_transaksi`
--
...
--
-- Struktur dari tabel `tr_jenis_ujian`
--
...
--
-- Dumping data untuk tabel `tr_jenis_ujian`
--
...
--
-- Struktur dari tabel `tr_jenis_wali`
--
...
--
-- Dumping data untuk tabel `tr_jenis_wali`
--
...
--
ALTER TABLE `td_bayanat`
  MODIFY `id_bayanat` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `td_kelas_nilai`
  MODIFY `id_kelas_nilai` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `td_ruangan`
  MODIFY `id_ruangan` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `td_ruangan_jadwal`
--
ALTER TABLE `td_ruangan_jadwal`
  MODIFY `id_ruangan_jadwal` int(6) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `tr_jenis_beasiswa`
  MODIFY `id_jns_beasiswa` int(2) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tr_jenis_jam`
--
ALTER TABLE `tr_jenis_jam`
  MODIFY `id_jns_jam` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `tr_jenis_santri`
  MODIFY `id_jns_santri` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
